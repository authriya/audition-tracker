    ...
    render() {
        ...
        return(
            ...
            <form method="get" className="add__audition__htmlForm" onSubmit = {e => this.handleSubmit(e)}>
                ...
                <select name="casting-office" id="casting-office" value = {this.state.castingOffice} className="audition__input" onChange = {e => this.castingOfficeChange(e.target.value)} required>
                ...
                <input id="project-name" type ="text"name="project-name" className="audition__input" value = {this.state.projectName} onChange = {e => this.projectNameChange(e.target.value)} required/>
                <fieldset id="project-type">
                    <legend htmlFor="project-type" className="audition__label">Project Type</legend>
                    <span className="audition__input"><input type="radio" id ="film" name="projectType" value="Film" checked = {this.isCheckedProjectType("Film")} onChange = {e => this.projectTypeChange(e.target.value)} required/>
                    <label htmlFor="film" className="audition__label__radio">Film</label></span>
                    <span className="audition__input"><input type="radio" id ="tv" name ="projectType" value="TV" checked = {this.isCheckedProjectType("TV")} onChange = {e => this.projectTypeChange(e.target.value)} required/>
                    <label htmlFor="tv" className="audition__label__radio">Television</label></span>
                    <span className="audition__input"><input type="radio" id ="theatre" name ="projectType" value="Theatre" checked = {this.isCheckedProjectType("Theatre")} onChange = {e => this.projectTypeChange(e.target.value)} required/>
                    <label htmlFor="theatre" className="audition__label__radio">Theatre</label></span>
                    <span className="audition__input"><input type="radio" id ="commercial" name ="projectType" value="Commercial" checked = {this.isCheckedProjectType("Commercial")} onChange = {e => this.projectTypeChange(e.target.value)} required/>
                ...
                <fieldset id="role-type">
                    ...
                    <span className="audition__input"><input type="radio" id ="series-regular"  name="roleType" value ="Series Regular" checked = {this.isCheckedRoleType('Series Regular')} onChange = {e => this.roleTypeChange(e.target.value)} required/>
                    <label htmlFor="series-regular" className="audition__label__radio">Series Regular</label></span>
                    <span className="audition__input"><input type="radio" id ="guest-star"  name="roleType" value ="Guest Star" checked = {this.isCheckedRoleType('Guest Star')} onChange = {e => this.roleTypeChange(e.target.value)} required/>
                    <label htmlFor="guest-star" className="audition__label__radio">Guest Star</label></span>
                    <span className="audition__input"><input type="radio" id ="co-star" name="roleType" value ="Co-Star" checked = {this.isCheckedRoleType('Co-Star')} onChange = {e => this.roleTypeChange(e.target.value)} required/>
                    <label htmlFor="co-star" className="audition__label__radio">Co-Star</label></span>
                    <span className="audition__input"><input type="radio" id ="lead" name="roleType" value ="Lead" checked = {this.isCheckedRoleType('Lead')} onChange = {e => this.roleTypeChange(e.target.value)} required/>
                    <label htmlFor="lead" className="audition__label__radio">Lead</label></span>
                    <span className="audition__input"><input type="radio" id="supporting" name="roleType" value ="Supporting" checked = {this.isCheckedRoleType('Supporting')} onChange = {e => this.roleTypeChange(e.target.value)} required/>
                    <label htmlFor="supporting">Supporting</label></span>
                </fieldset>
                <label htmlFor="date" className="audition__label">
                    When was it?
                    <input type="date" id="date" className="audition__input" name="date" value = {this.state.date} onChange = {e => this.dateChange(e.target.value)} required/>
                </label>
                <fieldset action="upload.php" method="post" className="clothing__htmlForm">
                    ...
                    <input type="text" id="clothing" value = {this.state.clothingNotes} className="audition__input" onChange = {e => this.clothingNotesChange(e.target.value)} required/>
                </fieldset>
                <fieldset id="rating">
                    <legend className="audition__label">How'd it go?</legend>
                    <span className="audition__input"><input type="radio" id="star5" name="rating" value="5" checked = {this.isCheckedRating('5')}onChange = {e => this.ratingChange(e.target.value)} required/>
                    <label htmlFor="star5" title="Rocks!">5 stars</label></span>
                    <span className="audition__input"><input type="radio" id="star4" name="rating" value="4" checked = {this.isCheckedRating('4')}onChange = {e => this.ratingChange(e.target.value)} required/>
                    <label htmlFor="star4" title="Pretty good">4 stars</label></span>
                    <span className="audition__input"><input type="radio" id="star3" name="rating" value="3" checked = {this.isCheckedRating('3')}onChange = {e => this.ratingChange(e.target.value)} required/>
                    <label htmlFor="star3" title="Meh">3 stars</label></span>
                    <span className="audition__input"><input type="radio" id="star2" name="rating" value="2" checked = {this.isCheckedRating('2')}onChange = {e => this.ratingChange(e.target.value)} required/>
                    <label htmlFor="star2" title="Kinda bad">2 stars</label></span>
                    <span className="audition__input"><input type="radio" id="star1" name="rating" value="1" checked = {this.isCheckedRating('1')}onChange = {e => this.ratingChange(e.target.value)} required/>
                ...
                <button type="submit" value="Edit Audition" name="submit" className="add__audition__submit">Edit Audition</button>
            </form>
            </div>
        )
    }
